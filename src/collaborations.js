...
export default function collaborations(){
   ...
   <h1>HotWheels Collaborations</h1>
  <p>
  ...
  <h3>Collaborating with McDonalds</h3>
  <img
      src={mcd_hw}
  ...
  <p>
    ...
    alt="Camaro Z-28 white" width="100%" height="200"/>
    The Camaro Z-28 were of the model from 1978 to 1981.
    </div>
    <br /> <br />
    <div className="col-sm-4">
    <img 
    src={_57T_Bird_hw_78}
    alt="57 T-Bird(1978)" width="100%" height="200"
    />
    The '57 T-Bird came out 1978 and first placed in the Flying Colors series.
    </div>
    </div>
  </p>
  </div>
    ...
    /*
    HotWheels Online Sources
    McDonald's Collaboration Source: https://hotwheels.fandom.com/wiki/McDonald%27s
    Camaro_Z-28 car Source:https://hotwheels.fandom.com/wiki/Camaro_Z-28
    '57 T-Bird car Source:https://hotwheels.fandom.com/wiki/%2757_T-Bird_(1978)     
    */
